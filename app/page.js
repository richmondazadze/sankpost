        ...
        <div className="text-center py-20 lg:py-32 relative">
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Button
              as="a"
              href="#features"
              className="bg-transparent border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white px-8 py-3 rounded-full text-lg transition duration-300 ease-in-out text-center"
            >
              Learn More
            </Button>
          </div>
